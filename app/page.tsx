  ...
  return (
    <section className="relative mx-auto w-10/12 md:w-3/4 lg:w-2/3 xl:w-7/12 mt-20 flex flex-col gap-16 mb-20">
      ...
      <section className="mx-auto mb-4 w-full w-6/6 flex flex-col">
        ...
        <FadeInOnScroll direction="right" threshold={0.2}>
          <h2 className="mb-16 text-center text-3xl font-normal leading-none tracking-tight md:text-3xl lg:text-4xl text-white">Contact <span className="underline underline-offset-3 decoration-6 decoration-orange-400 dark:decoration-orange-500">me</span></h2>
        </FadeInOnScroll>
