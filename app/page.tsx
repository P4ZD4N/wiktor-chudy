...
const projects = [
  ...
  },
  {
    ...
    description:
      "Backend app for library, which implements a lot of functionalities, that allows to effectively manage company. Created and designed with a thought of meeting all the requirements of a potential customer, who would be interested in ordering such app.",
