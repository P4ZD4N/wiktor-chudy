...
export default function TechSkillsSection() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold mb-6">Main <mark className="px-2 text-white bg-orange-500 rounded-sm">tech stack</mark></h2>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-6">Also <mark className="px-2 text-white bg-orange-500 rounded-sm">worked with</mark></h2>
